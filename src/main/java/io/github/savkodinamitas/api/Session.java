...
package io.github.savkodinamitas.api;
...
import io.github.savkodinamitas.query.dialect.*;
import io.github.savkodinamitas.query.internal.DBUpdateSolver;
import io.github.savkodinamitas.query.internal.PreparedStatementQuery;
import io.github.savkodinamitas.query.exceptions.ConnectionUnavailableException;
import io.github.savkodinamitas.query.exceptions.EntityObjectRequiredException;
import io.github.savkodinamitas.query.transaction.SQLTransactionBody;
import io.github.savkodinamitas.query.transaction.SQLValuedTransactionBody;
...
public class Session {
     ...
     * <p>
     * Used for mapping {@link PDO} objects
     *
     * @param queryBuilder query builder
     * @param resultClass  resulting {@link PDO} marked class
     * @return mapped list of {@link PDO} objects
     */
     ...
     * or by removing a row in joined table for {@link ManyToMany} relations
     *
     * @param obj1         first entity
     * @param obj2         second entity
     * @param relationName relation name
