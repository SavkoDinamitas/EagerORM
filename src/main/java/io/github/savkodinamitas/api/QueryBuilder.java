...
import io.github.savkodinamitas.query.internal.tree.*;
...
import io.github.savkodinamitas.query.exceptions.InvalidRelationPathException;
 ...
 * with {@link PDO}. For PDOs, select expressions may include custom aliases
...
public class QueryBuilder {
    ...
    /**
     * Constructs a {@code QueryBuilder} for returning {@link PDO}-annotated objects.
    ...
    /**
     * Constructs a {@code QueryBuilder} for {@link PDO}-annotated objects.
     ...
     * Intended for queries that map to {@link PDO} objects.
     *
